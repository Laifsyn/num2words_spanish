            ...
            'decenas: {
                if tens != 0 || units != 0 {
                    let unit_word = match (units, i) {
                        ...
                        // case `001_001_100...` => `un billón un millón cien mil...` instead of `uno billón uno millón cien mil...`
...
mod tests {
    ...
    fn lang_es_sub_thousands() {
        ...
        assert_eq!(es.to_cardinal(010).unwrap(), "diez");
    ...
    fn lang_es_thousands() {
        ...
        assert_eq!(es.to_cardinal(001_000).unwrap(), "mil");
        assert_eq!(es.to_cardinal(001_010).unwrap(), "mil diez");
        assert_eq!(es.to_cardinal(001_100).unwrap(), "mil cien");
        assert_eq!(es.to_cardinal(001_101).unwrap(), "mil ciento uno");
        assert_eq!(es.to_cardinal(001_110).unwrap(), "mil ciento diez");
        assert_eq!(es.to_cardinal(001_111).unwrap(), "mil ciento once");
        assert_eq!(es.to_cardinal(001_141).unwrap(), "mil ciento cuarenta y uno");
        // When thousands triplet isn't 1
        assert_eq!(es.to_cardinal(002_000).unwrap(), "dos mil");
        assert_eq!(es.to_cardinal(012_010).unwrap(), "doce mil diez");
    ...
    fn lang_es_millions() {
        let es = Spanish::default();
        // When thousands triplet is 1
        assert_eq!(es.to_cardinal(001_001_000).unwrap(), "un millón mil");
        assert_eq!(es.to_cardinal(010_001_010).unwrap(), "diez millones mil diez");
        assert_eq!(es.to_cardinal(019_001_010).unwrap(), "diecinueve millones mil diez");
        ...
        // when thousands triplet isn't 1
        assert_eq!(es.to_cardinal(001_002_010).unwrap(), "un millón dos mil diez");
        assert_eq!(es.to_cardinal(010_002_010).unwrap(), "diez millones dos mil diez");
        assert_eq!(es.to_cardinal(019_102_010).unwrap(), "diecinueve millones ciento dos mil diez");
        ...
        assert_eq!(es.to_cardinal(001_000_000).unwrap(), "un millón");
        assert_eq!(es.to_cardinal(001_000_000_000).unwrap(), "un billón");
        assert_eq!(es.to_cardinal(001_001_100_001).unwrap(), "un billón un millón cien mil uno");
    }
